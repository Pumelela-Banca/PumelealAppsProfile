...
urlpatterns = [
    path("/", render_about_api.as_view(), name="about_api"),
    path("/powerball/", PowerBallLister.as_view(), name="powerball"),
    path("/powerball/recent", PowerBallDetail.as_view(), name="powerball_detail"),
    path("/powerball/date/<yyyy:year>/<mm:month>/<dd:day>", PowerBallDate.as_view(), name="powerball_date"),
    ...
    path("/powerballplus/date/<yyyy:year>/<mm:month>/<dd:day>", PowerBallPlusDate.as_view(), name="powerballplus_date"),
    ...
    path("/dailylotto/date/<yyyy:year>/<mm:month>/<dd:day>", DailyLottoDate.as_view(), name="dailylotto_date"),
    path("/lotto1/", Lotto1Lister.as_view(), name="lotto1"),
    path("/lotto1/recent", Lotto1Detail.as_view(), name="lotto1_detail"),
    path("/lotto1/date/<yyyy:year>/<mm:month>/<dd:day>", Lotto1Date.as_view(), name="lotto1_date"),
    path("/lotto2/", Lotto2Lister.as_view(), name="lotto2"),
    path("/lotto2/recent", Lotto2Detail.as_view(), name="lotto2_detail"),
    path("/lotto2/date/<yyyy:year>/<mm:month>/<dd:day>", Lotto2Date.as_view(), name="lotto2_date"),
    path("/lotto3/", Lotto3Lister.as_view(), name="lotto3"),
    path("/lotto3/recent", Lotto3Detail.as_view(), name="lotto3_detail"),
    path("/lotto3/date/<yyyy:year>/<mm:month>/<dd:day>", Lotto3Date.as_view(), name="lotto3_date"),
]
